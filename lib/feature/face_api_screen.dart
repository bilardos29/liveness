...
class FaceApiScreen extends StatefulWidget {
  const FaceApiScreen({super.key});

  @override
  State<FaceApiScreen> createState() => _FaceApiScreenState();
}

class _FaceApiScreenState extends State<FaceApiScreen> {
  var image1 = new MatchFacesImage();
  var image2 = new MatchFacesImage();
  var img1 = Image.asset('images/portrait.png');
  var img2 = Image.asset('images/portrait.png');
  ...
  clearResults() {
    setState(() {
      img1 = Image.asset('images/portrait.png');
      img2 = Image.asset('images/portrait.png');
      _similarity = "nil";
      _liveness = "nil";
    });

...
class M7Screen extends StatefulWidget {
  const M7Screen({super.key});

  @override
  State<M7Screen> createState() => _M7ScreenState();
}

class _M7ScreenState extends State<M7Screen> {
  ...
  bool _isSelected(M7LivelynessStep step) {
    final M7LivelynessStepItem? doesExist = _veificationSteps.firstWhere(
      (p0) => p0.step == step,
    );
